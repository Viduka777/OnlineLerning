                                    ...
                                    <tr>
                                       ...
                                       <td>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn-link btn" href="{{asset('')}}admin/lesson/followers/view/{{$lesson->id}}">View</a>
                                        </td>
                                        <td>
                                            @if($lesson->status == 1)
                                        ...
                                        <td>
                                            @if($pending)
                                                ...
                                                <button type="button" class="btn btn-success btn-xs"
                                                        onclick="activate({{$lesson->id}})">Accept
                                                </button>
                                                <button type="button" class="btn btn-warning btn-xs"
                                                        onclick="reject({{$lesson->id}})">Reject
                                                </button>
                                            @else
                                                @if($lesson->status == 1)
                                                    <button type="button" class="btn btn-warning btn-xs"
                                                            onclick="deactivate({{$lesson->id}})">Deactivate
                                                    </button>
                                                @elseif($lesson->status == 0)
                                                    <button type="button" class="btn btn-success btn-xs"
                                                            onclick="activate({{$lesson->id}})">Accept
