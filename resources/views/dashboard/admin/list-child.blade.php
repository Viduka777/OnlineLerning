                        ...
                        <div class="x_content" class="col-md-4 col-sm-12 col-xs-12" style="position: relative;">
                            <table class="table table-striped projects">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 40%">Education Qualifications</th>
                                        ...
                                        <td>
                                            @if($pending)
                                                ...
                                                <button type="button" class="btn btn-success btn-xs"
                                                        onclick="activate({{$que->id}})">Accept
                                                </button>
                                                <button type="button" class="btn btn-warning btn-xs"
                                                        onclick="reject({{$que->id}})">Reject
                                                </button>
                                            @else
                                                @if($que->status == 1)
                                                    <button type="button" class="btn btn-warning btn-xs"
                                                            onclick="deactivate({{$que->id}})">Deactivate
                                                    </button>
                                                @elseif($que->status == 0)
                                                    <button type="button" class="btn btn-success btn-xs"
                                                            onclick="activate({{$que->id}})">Activate
                                                    </button>
                                                @endif
                                            @endif
