        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>Add Question To My Lesson</h3>
                </div>
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content" class="col-md-4 col-sm-12 col-xs-12" style="position: relative;">
                            ...
                            <form class="form-horizontal form-label-left" method="POST"
                                  action="{{ route('saveLessionTest') }}" enctype="multipart/form-data">
                                {{csrf_field()}}

                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Lesson
                                        <span
                                                class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select name="lesson_id" id="lesson_id" class="form-control col-md-7 col-xs-12"
                                                required="required">
                                            <option value="">Select Lesson</option>
                                            @foreach($lessions as $less)
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="" class="form-control col-md-5 col-xs-12"
                                               ...
                                               name="answer_1"
                                               required="required" type="text" value="{{ old('title') }}">
                                        <input type="radio" name="correct_answer" value="answer_1" checked> Correct
                                        Answer
                                    </div>
                                </div>
                                <div class="item form-group">
                                ...
                                <div class="item form-group">
                                    <label for="password" class="control-label col-md-3">File<span
                                                ></span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
