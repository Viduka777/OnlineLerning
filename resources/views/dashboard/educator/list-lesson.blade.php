                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="star-ratings-sprite">
                                                <span style="width:{{$lesson->rate}}%" class="star-ratings-sprite-rating" ></span>
                                            </div>
                                        </td>
                                        <td>
                                            {{\App\Models\CourseUser::where('course_id',$lesson->id)->count()}}
                                            <a href="{{asset('')}}educator/lesson/followers/view/{{$lesson->id}}">View</a>
                                        </td>
                                        <td>
                                            <!-- @if($lesson->status)
                                                <button type="button" class="btn btn-success btn-xs" onclick="activate({{$lesson->id}})">Active</button>
                                            @else
                                                <button type="button" class="btn btn-danger btn-xs" onclick="deactivate({{$lesson->id}})">Deactivated</button>
                                            @endif -->
                                            @if($lesson->status == 1)
                                        ...
                                        <td>
                                            @if($lesson->status)
                                                <!-- <button type="button" class="btn btn-warning btn-xs" onclick="deactivate({{$lesson->id}})">Deactivate</button> -->
                                            @else
                                                <!-- <button type="button" class="btn btn-success btn-xs" onclick="activate({{$lesson->id}})">Activate</button> -->
                                            @endif
                                            <a href="#" class="btn btn-info btn-xs" onclick="view_attachment('{{$lesson->lesson_type}}',{{$lesson->id}},'{{$lesson->file_path}}')">View Attachment
                                            </a>
                                            <a href="#" class="btn btn-danger btn-xs"
                                               onclick="delete_less({{$lesson->id}})"><i class="fa fa-trash-o"></i>
                                                Delete </a>
                                        </td>
                                    </tr>
                                    @php $x++; @endphp
