                        ...
                        <form class="form-horizontal" method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                            ...
                            <div class="">
                                <input id="phone" type="text" class="form-control" name="phone"
                                       value="" required autofocus placeholder="Phone">
                            </div>
                            <div class="">
                                <input id="occupation" type="text" class="form-control" name="occupation"
                                       value="" required autofocus placeholder="Occupation">
                            </div>
                            ...
                            <div class="educator-content">
                                <div>
                                    <br>
                                    <div class="col-md-3 text-left">
                                        <label for="" class="color-fff">Certificates</label>
                                    </div>
                                    <div class="col-md-9">
...
@section('extra-js')
    <script>
        $("input[name='user_regster_type'").click(function () {
            var radioValue = $("input[name='user_regster_type']:checked").val();
            if (radioValue == 'parent') {
                $('.educator-content').hide();
                $("#education_qualifications").prop('required', false);

            } else {
                $('.educator-content').show();
                $("#education_qualifications").prop('required', true);
            }
        });
    </script>
@endsection