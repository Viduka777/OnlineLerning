...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 12, 2019 at 01:48 PM
...
(6, 4, 'l2', 'fsdfsdf', 7, 'pdf', 'level_2', './uploads/edu-4/pdf/pdf-level_2-5c851ef707531.pdf', '69', 1000, 45, 1, NULL, '2019-03-10 08:58:07', '2019-06-12 04:51:42'),
...
(15, 6, 'less 01', 'scscass', NULL, 'img', 'level_2', './uploads/edu-6/img/img-level_1-5d00dbc4d9f9f.png', '0', 0, 11, 1, NULL, '2019-06-12 05:32:28', '2019-06-12 06:09:37'),
(16, 6, 'less 02', 'scscass', NULL, 'img', 'level_2', './uploads/edu-6/img/img-level_1-5d00dbc4d9f9f.png', '0', 0, 1, 1, NULL, '2019-06-12 05:32:28', '2019-06-12 06:05:53');

-- --------------------------------------------------------

--
-- Table structure for table `lessontest_users`
--

CREATE TABLE `lessontest_users` (
  `id` int(11) NOT NULL,
...
(2, 6, 12, 5, 1000, 0, 1, '2019-05-02 04:13:37', '2019-06-12 06:05:48'),
...
(12, 'wwwwwww', 'wwwww@gmail.com', NULL, '$2y$10$q0sxwKDs..9rXu/B46tI/.ouwExcMlV73aSx5Mc3/FbmW6Q29.Xn2', 'bUYdCa4kUZr3ecQBdP2H1uWhFMSS7hoAxvyrOGjc4tZQtN5BsVCludKgfgfv', 'child', NULL, NULL, 1, '2019-01-10', 3, 0, 2, 1, 0, '2019-01-20 07:49:11', '2019-05-02 03:45:31'),
...
--
-- Indexes for table `lessontest_users`
--
ALTER TABLE `lessontest_users`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `lessontest_users`
--
ALTER TABLE `lessontest_users`
